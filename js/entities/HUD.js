...
game.HUD.ScoreItem = me.Renderable.extend({
    ...
    init: function(x, y) {
        ...
        this.stepsFont = new me.Font('gamefont', 80, '#FEBE0A', 'center');
...
/*var Share = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        var shareText = 'Just made ' + game.data.steps + ' steps on Flappy Jeff! Can you beat me? Try online here!';
        var url = 'http://google.com';
        FB.ui(
            {
             method: 'feed',
             name: 'My Flappy Jeff Score!',
...
var Tweet = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        var shareText = 'Just made ' + game.data.steps + ' steps on Flappy Jeff! Can you beat me? Try online here!';
        var url = 'http://google.com';
        var hashtags = 'flappyjeff,crosschx'
